...
//IP must be manually set. Gross.
//When hosted, problem solved.
//For proof of concept, will use hard-coded
//IPs on back and front
/*app.listen(port, '0.0.0.0', function() {
  console.log('Listening to %s:%s'% ('0.0.0.0', port))
});*/
app.listen(port);
